...
export function NovoPerfilContent() {
  ...
  const handleSavePerfil = () => {
    ...
    // Aqui você faria a chamada para a API para salvar o perfil
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Preencha as informações básicas do novo perfil de acesso.
            </CardDescription>
          </CardHeader>
                  ...
                  <TabsContent key={categoria.id} value={categoria.id} className="mt-4">
                    <div className="border rounded-lg p-4 max-h-96 overflow-y-auto">
                      {temAcordeon ? (
                        ...
                        // Renderizar sem acordeons (Dashboard, Agenda, FAQ, Relatórios)
                        <div className="space-y-4">
                          {/* Botão Selecionar/Desmarcar Todos */}
                          <div className="flex justify-between items-center pb-2 border-b">
                            <span className="text-sm font-medium text-gray-700">
